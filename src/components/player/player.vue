        ...
        <div class="middle" @touchstart.prevent='middleTouchStart' @touchmove.prevent='middleTouchMove' @touchend='middleTouchEnd'>
          <div class="middle-l" ref="middleL">
            ...
            <div class="playing-lyric-wrapper">
              <div class="playing-lyric">{{playingLyirc}}</div>
            </div>
          </div>
          <scroll ref="lyricList" class="middle-r" :data='currentLyric && currentLyric.lines'>
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine" class="text" :class="{'current':currentLineNum===key}" v-for="(item, key) in currentLyric.lines" :key="key">{{item.txt}}</p>
              </div>
            </div>
          </scroll>
        </div>
